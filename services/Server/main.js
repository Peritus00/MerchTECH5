...
const allowedOrigins = [
  ...
  // Vercel preview URLs (unique per deployment: project-hash-owner-projects.vercel.app)
  '*.vercel.app',
...
// Compression middleware preserves CORS headers - order is: CORS -> Compression -> Routes
try {
  const {
  ...
  // Apply performance middleware (order matters - must be after CORS)
  // Response time tracking first (doesn't modify headers)
  app.use(responseTimeMiddleware);
  
  // Compression middleware (preserves existing headers including CORS)
  app.use(compressionMiddleware);
  
  // Static cache headers (skips OPTIONS requests)
