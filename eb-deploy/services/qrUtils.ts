...
export const downloadQRCode = async (
  ...
  try {
    ...
    console.log('💾 Copying to permanent location with correct filename...');
    // Copy the captured image to a new location with the correct filename
    const fileExtension = format === QRCodeFormat.PDF ? 'png' : format;
    ...
    console.log('💾 Saving to media library with filename:', finalFilename);
    // Save to media library with the properly named file
