      ...
      <head>
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .activation-button { background: #10b981; }
          .activation-button:hover { background: #059669; transform: translateY(-2px); }
          .preview-button { background: #f59e0b; }
          .preview-button:hover { background: #d97706; transform: translateY(-2px); }
          .app-download { 
            background: rgba(255,255,255,0.1); 
            border-radius: 20px; 
            padding: 20px; 
          ...
          .download-button:hover { background: #2563eb; transform: translateY(-2px); }
          .audio-player { 
            width: 100%; 
            margin: 20px 0; 
            border-radius: 10px;
