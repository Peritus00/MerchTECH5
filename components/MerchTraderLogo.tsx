...
interface MerchTraderLogoProps {
...
export const MerchTraderLogo: React.FC<MerchTraderLogoProps> = ({
  size = 'medium',
  variant = 'full',
  style,
  showText = true,
  ...
  const renderIcon = () => {
    try {
      return (
        <Image
          source={require('../assets/images/merchtraderlogogoldnoBgColor.png')}
...
export default MerchTraderLogo; 